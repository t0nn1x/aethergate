...
- [x] Task 2: Organize layered sprite assets and register initial variants
  ...
  Files:
  - `src/Entities/Player/Sprites/Parts/Head/*` (new/moved)
  - `src/Entities/Player/Sprites/Parts/Body/*` (new/moved)
  - `src/Entities/Player/Sprites/Parts/Legs/*` (new/moved)
  - `src/Entities/Player/Sprites/Weapons/*` (new)
...
- [x] Task 7: Create character creator UI panel (desktop first, adaptive layout)
  ...
  Files:
  - `src/Ui/Windows/CharacterCreator/character_creator_panel.tscn` (new)
  - `src/Ui/Windows/CharacterCreator/character_creator_panel.gd` (new)
...
- [x] Task 8: Gate session start with creator flow on first launch
  ...
  Files:
  - `src/Map/Overworld/overworld.tscn`
  - `src/World/Overworld/overworld.gd`
  - `src/World/Overworld/overworld_session_controller.gd` (if guard is needed)
  - `src/Ui/Windows/Gui/MainScreen/main_screen.gd` (only if signal flow needs adjustment)
  Logging requirements:
...
- [ ] Task 10: Manual runtime validation (desktop + mobile parity)
  ...
  - `src/World/Overworld/overworld.gd`
  - `src/Map/Overworld/overworld.tscn`
  - `src/Ui/Windows/CharacterCreator/*`
  - `src/Entities/Player/*`
  Logging requirements:
