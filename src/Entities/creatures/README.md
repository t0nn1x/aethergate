...
1. Place each sprite sheet under `src/Entities/creatures/catalog/<category>/creature_name/sprites/`.
...
Example:
- `src/Entities/creatures/catalog/humanoids/adventurous_adolescent/sprites/AdventurousAdolescent_128x32.png`
...
This updates:
- `src/Entities/creatures/catalog/<category>/creature_name/data/*.tres`
