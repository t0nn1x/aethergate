...
@export var player_input_config: PlayerInputConfig = preload("res://src/Gameplay/Player/Config/player_input_config.tres")
@export var player_movement_config: PlayerMovementConfig = preload("res://src/Gameplay/Player/Config/player_movement_config.tres")
