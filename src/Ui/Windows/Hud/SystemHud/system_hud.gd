...
@export var slot_texture: Texture2D = preload("res://src/Ui/Assets/Gui-Hud/Menu Buttons And Switch/Menu Buttons/button_slot.png")
@export var slot_hover_texture: Texture2D = preload("res://src/Ui/Assets/Gui-Hud/Menu Buttons And Switch/Menu Buttons/button_slot_hover_pressed.png")
@export var slot_active_texture: Texture2D = preload("res://src/Ui/Assets/Gui-Hud/Menu Buttons And Switch/Menu Buttons/button_slot_hover_pressed.png")
