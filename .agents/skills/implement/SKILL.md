...
- For localization refactors, verify `project.godot` translation entries and autoload paths match new locations, and ensure `.tres` translation resources are saved as UTF-8 without BOM to avoid parser failures
